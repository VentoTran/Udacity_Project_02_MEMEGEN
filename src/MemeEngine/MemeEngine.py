...
Create meme from Quote & Image database.
"""
...
class MemeEngine:
    ...
    def make_meme(self, img_path: str = None, body: str = None,
                  author: str = None, width: int = 500) -> str:
        ...
        try:
            with Image.open(img_path) as img:
                ...
                font = ImageFont.truetype(
                    "./_data/Font/FiraCode/FiraCodeNerdFont-Bold.ttf",
                    font_size)
